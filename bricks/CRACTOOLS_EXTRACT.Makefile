...
%%_CHIMERA_OUTPUT_PREFIX	= cractools# Prefix for name of the chimera output file (see below)
%%_SPLICE_OUTPUT_PREFIX		= cractools# Prefix for name of the splice output file (see below)
%%_MUTATION_OUTPUT_PREFIX	= cractools# Prefix for name of the mutation output file (see below)
%%_REFERENCE_FASTA				=
%%_LOG_FILE								=
